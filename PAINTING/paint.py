...
import PIL
import math
from matplotlib.pyplot import imread as mpl
from matplotlib.pyplot import imsave as mps
...
img_style  = skimage.transform.resize(img_style, img_content.shape, order=3) ##jwb
...
with tf.compat.v1.Session() as sess:
    ...
    optimizer = tf.contrib.opt.ScipyOptimizerInterface( L_total, method='L-BFGS-B', options={'maxiter': n_iterations_checkpoint})
